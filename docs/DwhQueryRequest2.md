...
json = "{}"
# create an instance of DwhQueryRequest2 from a JSON string
dwh_query_request2_instance = DwhQueryRequest2.from_json(json)
# print the JSON string representation of the object
print(DwhQueryRequest2.to_json())

# convert the object into a dict
dwh_query_request2_dict = dwh_query_request2_instance.to_dict()
# create an instance of DwhQueryRequest2 from a dict
dwh_query_request2_from_dict = DwhQueryRequest2.from_dict(dwh_query_request2_dict)
```
