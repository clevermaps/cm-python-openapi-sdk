...
class TestFilterByComp(unittest.TestCase):
    """FilterByComp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FilterByComp:
        """Test FilterByComp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FilterByComp`
        """
        model = FilterByComp()
        if include_optional:
            return FilterByComp(
