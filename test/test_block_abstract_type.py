...
class TestBlockAbstractType(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BlockAbstractType:
        """Test BlockAbstractType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BlockAbstractType`
        """
        model = BlockAbstractType()
        if include_optional:
            return BlockAbstractType(
                type = 'categories',
                title = '',
                description = '',
                split_property = 'awat5ikwowtta-3mh2lcafqw3zhes.i16mckwqaot6282x4vh6wt7cgd04d0gu12zwv6v61pi05te5cj19uo1-vud_-tc_vbqgp4vj0u4t9xwduicwscq-4zge8f37mn0',
                ...
                size_limit = 56,
                order_by = {property=property, direction=asc},
                vertical = True,
                condensed = True,
                dual_property = 'awat5ikwowtta-3mh2lcafqw3zhes.i16mckwqaot6282x4vh6wt7cgd04d0gu12zwv6v61pi05te5cj19uo1-vud_-tc_vbqgp4vj0u4t9xwduicwscq-4zge8f37mn0',
    ...
    def testBlockAbstractType(self):
        """Test BlockAbstractType"""
