...
class TestDashboardResponseDTO(unittest.TestCase):
    """DashboardResponseDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DashboardResponseDTO:
        """Test DashboardResponseDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DashboardResponseDTO`
        """
    ...
    def testDashboardResponseDTO(self):
        """Test DashboardResponseDTO"""
