    ...
    def make_instance(self, include_optional) -> MarkerSelectorContentDTO:
        ...
        if include_optional:
            return MarkerSelectorContentDTO(
                categories = [
                    {linkedLayers=[{visible=true, style=style, dataset=dataset}, {visible=true, style=style, dataset=dataset}], markers=[{addOnExpand=true, visible=true, marker=marker}, {addOnExpand=true, visible=true, marker=marker}], dataset=dataset}
                    ],
                granularity_categories = [
                    {styleType=color, splitPropertyName=splitPropertyName, dataset=dataset}
                    ],
                hide_granularity = True,
                keep_filtered = {granularity=true, markers=true},
