...
class TestSingleSelectDTO(unittest.TestCase):
    """SingleSelectDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SingleSelectDTO:
        """Test SingleSelectDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SingleSelectDTO`
        """
        model = SingleSelectDTO()
        if include_optional:
            return SingleSelectDTO(
                type = 'singleSelect',
