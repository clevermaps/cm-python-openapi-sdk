...
class ViewsApi:
    ...
    def _create_view_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/projects/{projectId}/md/views',
    ...
    def delete_view_by_id(
        ...
        _param = self._delete_view_by_id_serialize(
            project_id=project_id,
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def delete_view_by_id_with_http_info(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        id: Annotated[StrictStr, Field(description="Id of the view")],
        _request_timeout: Union[
    ...
    @validate_call
    def delete_view_by_id_without_preload_content(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        id: Annotated[StrictStr, Field(description="Id of the view")],
        _request_timeout: Union[
    ...
    def _delete_view_by_id_serialize(
        self,
        project_id,
        id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/projects/{projectId}/md/views/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_all_views(
        ...
        _param = self._get_all_views_serialize(
            project_id=project_id,
            page=page,
            size=size,
            sort=sort,
    ...
    @validate_call
    def get_all_views_with_http_info(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Number of the page")] = None,
        size: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="The count of records to return for one page")] = None,
    ...
    @validate_call
    def get_all_views_without_preload_content(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Number of the page")] = None,
        size: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="The count of records to return for one page")] = None,
    ...
    def get_view_by_name(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        name: Annotated[str, Field(strict=True, description="Name of the view")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_view_by_name_serialize(
            project_id=project_id,
            name=name,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_view_by_name_with_http_info(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        name: Annotated[str, Field(strict=True, description="Name of the view")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_view_by_name_without_preload_content(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        name: Annotated[str, Field(strict=True, description="Name of the view")],
        _request_timeout: Union[
    ...
    def _get_view_by_name_serialize(
        self,
        project_id,
        name,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/projects/{projectId}/md/views/{name}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_view_by_id(
        ...
        _param = self._update_view_by_id_serialize(
            project_id=project_id,
            id=id,
            if_match=if_match,
            view_dto=view_dto,
    ...
    @validate_call
    def update_view_by_id_without_preload_content(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        id: Annotated[StrictStr, Field(description="Id of the view")],
        if_match: Annotated[str, Field(strict=True, description="ETag value used for conditional updates")],
    ...
    def _update_view_by_id_serialize(
        self,
        project_id,
        id,
        if_match,
