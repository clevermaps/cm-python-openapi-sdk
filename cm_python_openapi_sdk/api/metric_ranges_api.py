...
class MetricRangesApi:
    ...
    @validate_call
    def accept_metric_ranges_with_http_info(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        dwh_cluster_id: Annotated[str, Field(strict=True, description="Id of the dwh cluster")],
        dwh_query_request1: DwhQueryRequest1,
    ...
    @validate_call
    def accept_metric_ranges_without_preload_content(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        dwh_cluster_id: Annotated[str, Field(strict=True, description="Id of the dwh cluster")],
        dwh_query_request1: DwhQueryRequest1,
    ...
    def _accept_metric_ranges_serialize(
        self,
        project_id,
        dwh_cluster_id,
        dwh_query_request1,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/projects/{projectId}/dwh/{dwhClusterId}/metricRanges',
    ...
    def get_metric_ranges(
        ...
        Get the result of the asynchronous metric ranges request submitted in [acceptMetricRanges](#operation/acceptMetricRanges). This endpoint implements long polling - see details in [getQueries](#operation/getQueries).  The resource returns these values for each metric: * `min` - minimal value for metric in given scope * `max` - maximal value for metric in given scope 
        ...
        _param = self._get_metric_ranges_serialize(
            project_id=project_id,
            dwh_cluster_id=dwh_cluster_id,
    ...
    @validate_call
    def get_metric_ranges_with_http_info(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        dwh_cluster_id: Annotated[str, Field(strict=True, description="Id of the dwh cluster")],
        dwh_cache_id: Annotated[str, Field(strict=True, description="Id of the dwh cache")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DwhMetricRangeResponse]:
        """Get metric ranges
    ...
    @validate_call
    def get_metric_ranges_without_preload_content(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        dwh_cluster_id: Annotated[str, Field(strict=True, description="Id of the dwh cluster")],
        dwh_cache_id: Annotated[str, Field(strict=True, description="Id of the dwh cache")],
    ...
    def _get_metric_ranges_serialize(
        self,
        project_id,
        dwh_cluster_id,
        dwh_cache_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/projects/{projectId}/dwh/{dwhClusterId}/metricRanges/{dwhCacheId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
