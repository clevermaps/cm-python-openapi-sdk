...
class ExportsApi:
    ...
    @validate_call
    def get_export_by_name(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        name: Annotated[str, Field(strict=True, description="Name of the export")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param project_id: Id of the project (required)
        :type project_id: str
        :param name: Name of the export (required)
        :type name: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_export_by_name_serialize(
            project_id=project_id,
            name=name,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_export_by_name_with_http_info(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        name: Annotated[str, Field(strict=True, description="Name of the export")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_export_by_name_without_preload_content(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        name: Annotated[str, Field(strict=True, description="Name of the export")],
        _request_timeout: Union[
    ...
    def _get_export_by_name_serialize(
        self,
        project_id,
        name,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/projects/{projectId}/md/exports/{name}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
