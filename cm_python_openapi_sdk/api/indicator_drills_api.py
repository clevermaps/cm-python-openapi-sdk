...
class IndicatorDrillsApi:
    ...
    @validate_call
    def create_indicator_drill_with_http_info(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        indicator_drill_dto: IndicatorDrillDTO,
        x_can_strict_json_validation: Optional[StrictBool] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[IndicatorDrillResponseDTO]:
        """Creates new Indicator Drill.
    ...
    @validate_call
    def create_indicator_drill_without_preload_content(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        indicator_drill_dto: IndicatorDrillDTO,
        x_can_strict_json_validation: Optional[StrictBool] = None,
    ...
    def _create_indicator_drill_serialize(
        self,
        project_id,
        indicator_drill_dto,
        ...
        if indicator_drill_dto is not None:
            _body_params = indicator_drill_dto
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/projects/{projectId}/md/indicatorDrills',
    ...
    @validate_call
    def delete_indicator_drill_by_id(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        ...
        :param project_id: Id of the project (required)
        :type project_id: str
        :param id: Id of the indicator drill (required)
        :type id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._delete_indicator_drill_by_id_serialize(
            project_id=project_id,
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def delete_indicator_drill_by_id_with_http_info(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        id: Annotated[StrictStr, Field(description="Id of the indicator drill")],
        _request_timeout: Union[
    ...
    @validate_call
    def delete_indicator_drill_by_id_without_preload_content(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        id: Annotated[StrictStr, Field(description="Id of the indicator drill")],
        _request_timeout: Union[
    ...
    def _delete_indicator_drill_by_id_serialize(
        self,
        project_id,
        id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/projects/{projectId}/md/indicatorDrills/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_all_indicator_drills(
        ...
        _param = self._get_all_indicator_drills_serialize(
            project_id=project_id,
            page=page,
            size=size,
            sort=sort,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "IndicatorDrillPagedModelDTO",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def get_all_indicator_drills_with_http_info(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Number of the page")] = None,
        size: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="The count of records to return for one page")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[IndicatorDrillPagedModelDTO]:
        """Returns paged collection of all Indicator Drills in a project.
    ...
    @validate_call
    def get_all_indicator_drills_without_preload_content(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Number of the page")] = None,
        size: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="The count of records to return for one page")] = None,
    ...
    def _get_all_indicator_drills_serialize(
        self,
        project_id,
        page,
        size,
    ...
    def get_indicator_drill_by_id(
        ...
        _param = self._get_indicator_drill_by_id_serialize(
            project_id=project_id,
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_indicator_drill_by_id_with_http_info(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        id: Annotated[StrictStr, Field(description="Id of the indicator drill")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_indicator_drill_by_id_without_preload_content(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        id: Annotated[StrictStr, Field(description="Id of the indicator drill")],
        _request_timeout: Union[
    ...
    def _get_indicator_drill_by_id_serialize(
        self,
        project_id,
        id,
        _request_auth,
    ...
    @validate_call
    def get_indicator_drill_by_name(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        name: Annotated[str, Field(strict=True, description="Name of the indicator drill")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param project_id: Id of the project (required)
        :type project_id: str
        :param name: Name of the indicator drill (required)
        :type name: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_indicator_drill_by_name_serialize(
            project_id=project_id,
            name=name,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_indicator_drill_by_name_with_http_info(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        name: Annotated[str, Field(strict=True, description="Name of the indicator drill")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_indicator_drill_by_name_without_preload_content(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        name: Annotated[str, Field(strict=True, description="Name of the indicator drill")],
        _request_timeout: Union[
    ...
    def _get_indicator_drill_by_name_serialize(
        self,
        project_id,
        name,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/projects/{projectId}/md/indicatorDrills/{name}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def update_indicator_drill_by_id(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        id: Annotated[StrictStr, Field(description="Id of the indicator drill")],
        ...
        _param = self._update_indicator_drill_by_id_serialize(
            project_id=project_id,
            id=id,
            if_match=if_match,
            indicator_drill_dto=indicator_drill_dto,
    ...
    @validate_call
    def update_indicator_drill_by_id_with_http_info(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        id: Annotated[StrictStr, Field(description="Id of the indicator drill")],
        if_match: Annotated[str, Field(strict=True, description="ETag value used for conditional updates")],
    ...
    @validate_call
    def update_indicator_drill_by_id_without_preload_content(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        id: Annotated[StrictStr, Field(description="Id of the indicator drill")],
        if_match: Annotated[str, Field(strict=True, description="ETag value used for conditional updates")],
    ...
    def _update_indicator_drill_by_id_serialize(
        self,
        project_id,
        id,
        if_match,
