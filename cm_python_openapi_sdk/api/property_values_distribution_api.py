...
class PropertyValuesDistributionApi:
    ...
    @validate_call
    def accept_property_values_distribution(
        self,
        ...
        dwh_property_values_distribution_request: DwhPropertyValuesDistributionRequest,
        ...
        :param dwh_property_values_distribution_request: (required)
        :type dwh_property_values_distribution_request: DwhPropertyValuesDistributionRequest
        ...
        _param = self._accept_property_values_distribution_serialize(
            project_id=project_id,
            dwh_cluster_id=dwh_cluster_id,
            dwh_property_values_distribution_request=dwh_property_values_distribution_request,
    ...
    @validate_call
    def accept_property_values_distribution_with_http_info(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        dwh_cluster_id: Annotated[str, Field(strict=True, description="Id of the dwh cluster")],
        dwh_property_values_distribution_request: DwhPropertyValuesDistributionRequest,
    ...
    @validate_call
    def accept_property_values_distribution_without_preload_content(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        dwh_cluster_id: Annotated[str, Field(strict=True, description="Id of the dwh cluster")],
        dwh_property_values_distribution_request: DwhPropertyValuesDistributionRequest,
    ...
    def _accept_property_values_distribution_serialize(
        self,
        project_id,
        dwh_cluster_id,
        dwh_property_values_distribution_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if dwh_property_values_distribution_request is not None:
            _body_params = dwh_property_values_distribution_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/projects/{projectId}/dwh/{dwhClusterId}/propertyValuesDistributions',
    ...
    def get_property_values_distribution(
        ...
        null_cache_id: Annotated[StrictStr, Field(description="The ID of a cached null values distribution result")],
        var_property: Annotated[StrictStr, Field(description="Dataset's property identifier")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Get the result of the asynchronous property values distributions request submitted in [acceptPropertyValuesDistribution](#operation/acceptPropertyValuesDistribution).  This endpoint implements long polling - see details in [getQueries](#operation/getQueries). 
        ...
        :param null_cache_id: The ID of a cached null values distribution result (required)
        :type null_cache_id: str
        :param var_property: Dataset's property identifier (required)
        ...
        _param = self._get_property_values_distribution_serialize(
            project_id=project_id,
            dwh_cluster_id=dwh_cluster_id,
            dwh_cache_id=dwh_cache_id,
            null_cache_id=null_cache_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DwhMetricValuesDistributionResponse",
            '404': None,
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def get_property_values_distribution_with_http_info(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        dwh_cluster_id: Annotated[str, Field(strict=True, description="Id of the dwh cluster")],
        dwh_cache_id: Annotated[str, Field(strict=True, description="Id of the dwh cache")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DwhMetricValuesDistributionResponse]:
        """get_property_values_distribution
    ...
    @validate_call
    def get_property_values_distribution_without_preload_content(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        dwh_cluster_id: Annotated[str, Field(strict=True, description="Id of the dwh cluster")],
        dwh_cache_id: Annotated[str, Field(strict=True, description="Id of the dwh cache")],
    ...
    def _get_property_values_distribution_serialize(
        self,
        project_id,
        dwh_cluster_id,
        dwh_cache_id,
        ...
        # process the query parameters
        if null_cache_id is not None:
            
            _query_params.append(('nullCacheId', null_cache_id))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/projects/{projectId}/dwh/{dwhClusterId}/propertyValuesDistributions/{dwhCacheId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
