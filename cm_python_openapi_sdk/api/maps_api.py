...
class MapsApi:
    ...
    def _create_map_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/projects/{projectId}/md/maps',
    ...
    def delete_map_by_id(
        ...
        :param project_id: Id of the project (required)
        :type project_id: str
        :param id: Id of the map (required)
        :type id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._delete_map_by_id_serialize(
            project_id=project_id,
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def delete_map_by_id_with_http_info(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        id: Annotated[StrictStr, Field(description="Id of the map")],
        _request_timeout: Union[
    ...
    @validate_call
    def delete_map_by_id_without_preload_content(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        id: Annotated[StrictStr, Field(description="Id of the map")],
        _request_timeout: Union[
    ...
    def _delete_map_by_id_serialize(
        self,
        project_id,
        id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/projects/{projectId}/md/maps/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_all_maps(
        ...
        _param = self._get_all_maps_serialize(
            project_id=project_id,
            page=page,
            size=size,
            sort=sort,
    ...
    @validate_call
    def get_all_maps_with_http_info(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Number of the page")] = None,
        size: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="The count of records to return for one page")] = None,
    ...
    @validate_call
    def get_all_maps_without_preload_content(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Number of the page")] = None,
        size: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="The count of records to return for one page")] = None,
    ...
    def get_map_by_id(
        ...
        _param = self._get_map_by_id_serialize(
            project_id=project_id,
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_map_by_id_with_http_info(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        id: Annotated[StrictStr, Field(description="Id of the map")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_map_by_id_without_preload_content(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        id: Annotated[StrictStr, Field(description="Id of the map")],
        _request_timeout: Union[
    ...
    def get_map_by_name(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        name: Annotated[str, Field(strict=True, description="Name of the map")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param project_id: Id of the project (required)
        :type project_id: str
        :param name: Name of the map (required)
        :type name: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_map_by_name_serialize(
            project_id=project_id,
            name=name,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_map_by_name_with_http_info(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        name: Annotated[str, Field(strict=True, description="Name of the map")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_map_by_name_without_preload_content(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        name: Annotated[str, Field(strict=True, description="Name of the map")],
        _request_timeout: Union[
    ...
    def _get_map_by_name_serialize(
        self,
        project_id,
        name,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/projects/{projectId}/md/maps/{name}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_map_by_id(
        ...
        _param = self._update_map_by_id_serialize(
            project_id=project_id,
            id=id,
            if_match=if_match,
            map_dto=map_dto,
    ...
    @validate_call
    def update_map_by_id_with_http_info(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        id: Annotated[StrictStr, Field(description="Id of the map")],
        if_match: Annotated[str, Field(strict=True, description="ETag value used for conditional updates")],
    ...
    @validate_call
    def update_map_by_id_without_preload_content(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        id: Annotated[StrictStr, Field(description="Id of the map")],
        if_match: Annotated[str, Field(strict=True, description="ETag value used for conditional updates")],
    ...
    def _update_map_by_id_serialize(
        self,
        project_id,
        id,
        if_match,
