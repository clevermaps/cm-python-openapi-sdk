...
class DatasetsApi:
    ...
    def create_dataset_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DatasetResponseDTO]:
        """Creates new dataset
    ...
    def get_dataset_by_name(
        ...
        _param = self._get_dataset_by_name_serialize(
            project_id=project_id,
            name=name,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_dataset_by_name_with_http_info(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        name: Annotated[str, Field(strict=True, description="Name of the dataset")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_dataset_by_name_without_preload_content(
        self,
        project_id: Annotated[str, Field(strict=True, description="Id of the project")],
        name: Annotated[str, Field(strict=True, description="Name of the dataset")],
        _request_timeout: Union[
    ...
    def _get_dataset_by_name_serialize(
        self,
        project_id,
        name,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/projects/{projectId}/md/datasets/{name}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
