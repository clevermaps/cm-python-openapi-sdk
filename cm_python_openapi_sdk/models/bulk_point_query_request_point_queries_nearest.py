...
class BulkPointQueryRequestPointQueriesNearest(BaseModel):
    """
    BulkPointQueryRequestPointQueriesNearest
    """ # noqa: E501
    query_id: Optional[StrictStr] = Field(default=None, alias="queryId")
    type: StrictStr
    options: BulkPointQueryPointQueriesOptionNearest
    dataset: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "options": BulkPointQueryPointQueriesOptionNearest.from_dict(obj["options"]) if obj.get("options") is not None else None,
