...
class DatasetPagedModelDTO(BaseModel):
    ...
    """ # noqa: E501
    content: Optional[List[DatasetResponseDTO]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "content": [DatasetResponseDTO.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
            "links": obj.get("links"),
