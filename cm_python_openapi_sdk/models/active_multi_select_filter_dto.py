...
class ActiveMultiSelectFilterDTO(BaseModel):
    ...
    """ # noqa: E501
    default_values: DefaultValuesMultiSelectDTO = Field(alias="defaultValues")
    type: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["defaultValues", "type", "property", "orderBy"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['multiSelect']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "defaultValues": DefaultValuesMultiSelectDTO.from_dict(obj["defaultValues"]) if obj.get("defaultValues") is not None else None,
            "type": obj.get("type"),
