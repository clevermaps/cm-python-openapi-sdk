...
class DwhQueryRequest2(BaseModel):
    """
    DwhQueryRequest2
    """ # noqa: E501
    ...
    having: Optional[List[Having1]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "having": [Having1.from_dict(_item) for _item in obj["having"]] if obj.get("having") is not None else None,
