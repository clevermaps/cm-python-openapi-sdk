...
class ActiveHistogramFilterDTO(BaseModel):
    ...
    """ # noqa: E501
    default_values: DefaultValuesHistogramDTO = Field(alias="defaultValues")
    type: StrictStr
    var_property: Annotated[str, Field(strict=True)] = Field(alias="property")
    format: Optional[FormatDTO] = None
    __properties: ClassVar[List[str]] = ["defaultValues", "type", "property", "format"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "defaultValues": DefaultValuesHistogramDTO.from_dict(obj["defaultValues"]) if obj.get("defaultValues") is not None else None,
            "type": obj.get("type"),
