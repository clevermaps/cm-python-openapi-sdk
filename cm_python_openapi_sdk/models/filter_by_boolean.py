...
class FilterByBoolean(BaseModel):
    """
    FilterByBoolean
    """ # noqa: E501
    operator: StrictStr
    content: List[FilterBy]
    __properties: ClassVar[List[str]] = ["operator", "content"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "content": [FilterBy.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None
        })
        return _obj

from cm_python_openapi_sdk.models.filter_by import FilterBy
# TODO: Rewrite to not use raise_errors
FilterByBoolean.model_rebuild(raise_errors=False)
