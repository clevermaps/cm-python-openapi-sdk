...
class AvailableDatasetsRequest(BaseModel):
    """
    AvailableDatasetsRequest
    """ # noqa: E501
    metrics: Annotated[List[DwhQueryPropertyTypes], Field(min_length=1)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metrics": [DwhQueryPropertyTypes.from_dict(_item) for _item in obj["metrics"]] if obj.get("metrics") is not None else None
        })
        return _obj
