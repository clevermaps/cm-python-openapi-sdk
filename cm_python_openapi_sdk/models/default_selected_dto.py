...
class DefaultSelectedDTO(BaseModel):
    ...
    coordinates: Optional[List[CenterDTO]] = None
    __properties: ClassVar[List[str]] = ["dataset", "ids", "coordinates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ids": obj.get("ids"),
            "coordinates": [CenterDTO.from_dict(_item) for _item in obj["coordinates"]] if obj.get("coordinates") is not None else None
        })
        return _obj
