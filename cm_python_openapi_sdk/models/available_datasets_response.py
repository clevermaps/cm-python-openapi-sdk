...
class AvailableDatasetsResponse(BaseModel):
    ...
    """ # noqa: E501
    content: Optional[Annotated[List[AvailableDatasetsResponseContentInner], Field(min_length=1)]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "content": [AvailableDatasetsResponseContentInner.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None
        })
        return _obj
