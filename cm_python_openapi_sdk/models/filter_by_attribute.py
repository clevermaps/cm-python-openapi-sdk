...
class FilterByAttribute(BaseModel):
    ...
    query: DwhQueryRequest
    operator: StrictStr
    __properties: ClassVar[List[str]] = ["property", "function", "query", "operator"]
    ...
    def operator_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['inAttribute', 'notInAttribute']):
            raise ValueError("must be one of enum values ('inAttribute', 'notInAttribute')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "query": DwhQueryRequest.from_dict(obj["query"]) if obj.get("query") is not None else None,
...
FilterByAttribute.model_rebuild(raise_errors=False)
