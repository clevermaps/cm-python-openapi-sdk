...
class BlockRowAbstractType(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # check if data type is `BlockRowDTO`
        if _data_type == "blockRow":
        ...
        # check if data type is `IndicatorLinkDTO`
        if _data_type == "indicator":
            instance.actual_instance = IndicatorLinkDTO.from_json(json_str)
            return instance

        # check if data type is `IndicatorGroupDTO`
        if _data_type == "indicatorGroup":
        ...
        # check if data type is `IndicatorGroupDTO`
        if _data_type == "IndicatorGroupDTO":
            instance.actual_instance = IndicatorGroupDTO.from_json(json_str)
            return instance

        # check if data type is `IndicatorLinkDTO`
        if _data_type == "IndicatorLinkDTO":
            instance.actual_instance = IndicatorLinkDTO.from_json(json_str)
            return instance
