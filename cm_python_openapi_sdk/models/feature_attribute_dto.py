...
class FeatureAttributeDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "value", "format", "layout"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['property', 'expression']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": obj.get("value"),
            "format": AttributeFormatDTO.from_dict(obj["format"]) if obj.get("format") is not None else None,
