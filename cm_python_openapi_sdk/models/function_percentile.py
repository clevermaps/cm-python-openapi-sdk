...
class FunctionPercentile(BaseModel):
    ...
    type: StrictStr
    content: Annotated[List[DwhQueryPropertyTypesFunctionPercentile], Field(min_length=1)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "content": [DwhQueryPropertyTypesFunctionPercentile.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
...
FunctionPercentile.model_rebuild(raise_errors=False)
