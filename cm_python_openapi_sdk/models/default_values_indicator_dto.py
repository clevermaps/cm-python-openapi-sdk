...
class DefaultValuesIndicatorDTO(BaseModel):
    ...
    """ # noqa: E501
    values: Optional[Annotated[List[Optional[Union[StrictFloat, StrictInt]]], Field(min_length=2, max_length=2)]] = None
    ...
    __properties: ClassVar[List[str]] = ["values", "breaks", "displayIntervals", "granularity"]
