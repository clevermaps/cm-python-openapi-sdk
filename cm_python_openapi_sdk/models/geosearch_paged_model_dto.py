...
class GeosearchPagedModelDTO(BaseModel):
    """
    ...
    content: Optional[List[QueryHitDTO]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "links": obj.get("links"),
            "content": [QueryHitDTO.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
