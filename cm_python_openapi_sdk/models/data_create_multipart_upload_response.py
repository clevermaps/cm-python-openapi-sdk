...
class DataCreateMultipartUploadResponse(BaseModel):
    """
    ...
    upload_urls_encoded: Optional[List[StrictStr]] = Field(default=None, alias="uploadUrlsEncoded")
    ...
    __properties: ClassVar[List[str]] = ["id", "uploadId", "uploadUrls", "uploadUrlsEncoded", "links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "uploadUrlsEncoded": obj.get("uploadUrlsEncoded"),
            "links": obj.get("links")
        })
        return _obj
