...
class PasswordChangeDTO(BaseModel):
    ...
    PasswordChangeDTO
    """ # noqa: E501
    old_password: Annotated[str, Field(strict=True, max_length=100)] = Field(alias="oldPassword")
    new_password: Annotated[str, Field(strict=True, max_length=100)] = Field(alias="newPassword")
