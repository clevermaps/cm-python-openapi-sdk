...
class ResultSetFilterComp(BaseModel):
    """
    ResultSetFilterComp
    """ # noqa: E501
    property_id: Annotated[str, Field(min_length=1, strict=True, max_length=60)] = Field(alias="propertyId")
    value: Optional[Any] = None
    operator: StrictStr
    __properties: ClassVar[List[str]] = ["propertyId", "value", "operator"]
