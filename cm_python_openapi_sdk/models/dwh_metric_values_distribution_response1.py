...
class DwhMetricValuesDistributionResponse1(BaseModel):
    """
    DwhMetricValuesDistributionResponse1
    """ # noqa: E501
    content: List[DwhMetricValuesDistributionResponseContentInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "content": [DwhMetricValuesDistributionResponseContentInner.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None
        })
        return _obj
