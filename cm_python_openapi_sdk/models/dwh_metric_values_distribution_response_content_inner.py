...
class DwhMetricValuesDistributionResponseContentInner(BaseModel):
    """
    ...
    content: Optional[Annotated[List[DwhMetricValuesDistributionResponseContentInnerContentInner], Field(min_length=1)]] = None
    __properties: ClassVar[List[str]] = ["min", "max", "content"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "min": obj.get("min"),
            "max": obj.get("max"),
            "content": [DwhMetricValuesDistributionResponseContentInnerContentInner.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None
        })
        return _obj
