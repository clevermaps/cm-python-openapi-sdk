...
class AuditLogPagedResource(BaseModel):
    """
    ...
    content: List[AuditLogSingleResource]
    page: AuditLogPagedResourcePage
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "links": obj.get("links"),
            "content": [AuditLogSingleResource.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
            "page": AuditLogPagedResourcePage.from_dict(obj["page"]) if obj.get("page") is not None else None
        })
        return _obj
