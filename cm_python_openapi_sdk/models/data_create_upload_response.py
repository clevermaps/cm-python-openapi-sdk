...
class DataCreateUploadResponse(BaseModel):
    """
    DataCreateUploadResponse
    """ # noqa: E501
    id: StrictStr
    upload_url: StrictStr = Field(alias="uploadUrl")
    upload_url_encoded: Optional[StrictStr] = Field(default=None, alias="uploadUrlEncoded")
    ...
    __properties: ClassVar[List[str]] = ["id", "uploadUrl", "uploadUrlEncoded", "links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "uploadUrlEncoded": obj.get("uploadUrlEncoded"),
            "links": obj.get("links")
        })
        return _obj
