...
class DwhPropertyValuesDistributionRequest(BaseModel):
    """
    ...
    buckets: Optional[StrictInt] = 20
    min: Optional[Union[StrictFloat, StrictInt]] = None
    max: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["executionContext", "property", "buckets", "min", "max"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "buckets": obj.get("buckets") if obj.get("buckets") is not None else 20,
            "min": obj.get("min"),
            "max": obj.get("max")
        })
        return _obj
