...
class DistributionDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "title", "indicator", "defaultDataset", "collapsed", "visualized"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['distribution']):
            raise ValueError("must be one of enum values ('distribution')")
        return value
