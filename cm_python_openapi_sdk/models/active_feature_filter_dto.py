...
class ActiveFeatureFilterDTO(BaseModel):
    ...
    """ # noqa: E501
    default_values: DefaultValuesFeatureDTO = Field(alias="defaultValues")
    compared: Optional[StrictBool] = None
    type: StrictStr
    dataset: Annotated[str, Field(strict=True)]
    __properties: ClassVar[List[str]] = ["defaultValues", "compared", "type", "dataset"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "defaultValues": DefaultValuesFeatureDTO.from_dict(obj["defaultValues"]) if obj.get("defaultValues") is not None else None,
