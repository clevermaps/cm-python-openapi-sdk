...
class ActiveIndicatorFilterDTO(BaseModel):
    ...
    """ # noqa: E501
    default_values: DefaultValuesIndicatorDTO = Field(alias="defaultValues")
    type: StrictStr
    indicator: Annotated[str, Field(strict=True)]
    filter_selection: Optional[StrictBool] = Field(default=None, alias="filterSelection")
    __properties: ClassVar[List[str]] = ["defaultValues", "type", "indicator", "filterSelection"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "defaultValues": DefaultValuesIndicatorDTO.from_dict(obj["defaultValues"]) if obj.get("defaultValues") is not None else None,
            "type": obj.get("type"),
            "indicator": obj.get("indicator"),
            "filterSelection": obj.get("filterSelection")
        })
        return _obj
