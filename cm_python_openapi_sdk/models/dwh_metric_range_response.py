...
class DwhMetricRangeResponse(BaseModel):
    """
    DwhMetricRangeResponse
    """ # noqa: E501
    content: Annotated[List[DwhMetricRangeResponseContentInner], Field(min_length=1)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "content": [DwhMetricRangeResponseContentInner.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None
        })
        return _obj
