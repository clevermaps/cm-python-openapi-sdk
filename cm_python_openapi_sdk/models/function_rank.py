...
class FunctionRank(BaseModel):
    ...
    type: StrictStr
    content: Annotated[List[DwhQueryPropertyTypesFunctionRank], Field(min_length=1)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "content": [DwhQueryPropertyTypesFunctionRank.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
...
FunctionRank.model_rebuild(raise_errors=False)
