...
class ViewResponseDTO(BaseModel):
    """
    ViewResponseDTO
    """ # noqa: E501
    ...
    access_info: Optional[AccessInfoDTO] = Field(default=None, alias="accessInfo")
    version: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["id", "name", "type", "title", "description", "content", "links", "page", "accessInfo", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "content": ViewContentDTO.from_dict(obj["content"]) if obj.get("content") is not None else None,
            "links": obj.get("links"),
            "page": PageDTO.from_dict(obj["page"]) if obj.get("page") is not None else None,
            "accessInfo": AccessInfoDTO.from_dict(obj["accessInfo"]) if obj.get("accessInfo") is not None else None,
