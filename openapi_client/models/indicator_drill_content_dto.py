...
class IndicatorDrillContentDTO(BaseModel):
    """
    IndicatorDrillContentDTO
    """ # noqa: E501
    blocks: Optional[List[BlockAbstractType]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "blocks": [BlockAbstractType.from_dict(_item) for _item in obj["blocks"]] if obj.get("blocks") is not None else None
        })
        return _obj
