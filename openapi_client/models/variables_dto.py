...
class VariablesDTO(BaseModel):
    ...
    variables: Annotated[List[VariableDTO], Field(min_length=1)]
    __properties: ClassVar[List[str]] = ["type", "title", "variables"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "title": obj.get("title"),
            "variables": [VariableDTO.from_dict(_item) for _item in obj["variables"]] if obj.get("variables") is not None else None
        })
        return _obj
